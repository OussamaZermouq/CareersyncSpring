...
import com.pfa.Careersync.Token.Token;
import com.pfa.Careersync.Token.TokenRepository;
import com.pfa.Careersync.Token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        var user= User.builder()
                ...
                .prenom_user(request.getPrenom_user())
